subroutine XRayOpacityAtm2(NoOpacSpec,WaveL,nLines,vAngle,OpacSpec)
!*******************************************************************************
...
open(100,file='./Atmosphere/JupiterColumnDensity_2km_EqMixing.dat',status='old')
read(100,*) !Skip header lines
do Alt=1,AtmosLen !Read in the column density values
  read(100,*) Altitude(Alt),cdH2(Alt),cdHe(Alt),cdCH4(Alt),cdTot(Alt),&
