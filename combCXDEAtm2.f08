subroutine combCXDEAtm2(version,vAngle)
!*******************************************************************************
...
do Ang=1,4
  ...
  do ChS=1,nChS !O6+, O7+, S8+ - S14+
    if(Ang.le.3)then
      if(ChS.le.2)write(filename,"('./Output/XRayAtm2/',A,'/Points/',I0,&
        '/Oxy_',I0,'_CX.dat')") trim(version),nint(vAngle(Ang)),ChS+5
      if(ChS.ge.3)write(filename,"('./Output/XRayAtm2/',A,'/Points/',I0,&
        '/Sul_',I0,'_CX.dat')") trim(version),nint(vAngle(Ang)),ChS+5
    else if(Ang.eq.4)then
      if(ChS.le.2)write(filename,"('./Output/XRayAtm2/',A,'/Points/Oxy_',I0,&
        '_CX.dat')") trim(version),ChS+5
      if(ChS.ge.3)write(filename,"('./Output/XRayAtm2/',A,'/Points/Sul_',I0,&
        '_CX.dat')") trim(version),ChS+5
    end if
    ...
    if(Ang.le.3)then
      if(ChS.le.2)write(filename,"('./Output/XRayAtm2/',A,'/Points/',I0,&
        '/Oxy_',I0,'_DE.dat')") trim(version),nint(vAngle(Ang)),ChS+5
      if(ChS.ge.3)write(filename,"('./Output/XRayAtm2/',A,'/Points/',I0,&
        '/Sul_',I0,'_DE.dat')") trim(version),nint(vAngle(Ang)),ChS+5
    else if(Ang.eq.4)then
      if(ChS.le.2)write(filename,"('./Output/XRayAtm2/',A,'/Points/Oxy_',I0,&
  ...
  do ChS=1,nChS
    if(Ang.le.3)then
      ...
      if(ChS.le.2)write(filename,"('./Output/XRayAtm2/',A,'/Points/CX+DE_Oxy_'&
        ,I0,'.dat')") trim(version),ChS+5
      if(ChS.ge.3)write(filename,"('./Output/XRayAtm2/',A,'/Points/CX+DE_Sul_'&
        ,I0,'.dat')") trim(version),ChS+5
    end if
