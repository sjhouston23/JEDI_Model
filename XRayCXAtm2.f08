subroutine XRaySpectraCXAtm2(version,vAngle)
!*******************************************************************************
...
!*** Calculate synthetic spectra from oxygen precipitation
  do Eng=1,1 !Loop through every initial oxygen ion energy
    ...
    write(filename,"('./Output/XRayAtm2/',A,'/SpecVsAlt/Oxy_',I0,'_CX.dat')")&
          trim(version),OxyChS
    ...
    close(103)
    write(filename,"('./Output/XRayAtm2/',A,'/Points/Oxy_',I0,'_CX.dat')")&
          trim(version),OxyChS
...
!*** Calculate opacity effects
    do Ang=1,4 !Loop through each viewing angle
      ...
      write(filename,"('./Output/XRayAtm2/',A,'/Points/',I0,'/Oxy_',I0,&
                     '_CX.dat')") trim(version),int(vAngle(Ang)),OxyChS
      open(unit=106,file=filename)
      do i=1,nLines
...
!*** Calculate synthetic spectra from sulfur precipitation
  do Eng=1,1
    ...
    write(filename,"('./Output/XRayAtm2/',A,'/SpecVsAlt/Sul_',I0,'_CX.dat')")&
          trim(version),SulChS
    open(unit=103,file=filename)
    ...
    close(103)
    write(filename,"('./Output/XRayAtm2/',A,'/Points/Sul_',I0,'_CX.dat')")&
          trim(version),SulChS
    open(unit=106,file=filename)
    do i=1,nLines
...
!*** Calculate opacity effects
    do Ang=1,4 !Loop through each viewing angle
      ...
      write(filename,"('./Output/XRayAtm2/',A,'/Points/',I0,'/Sul_',I0,&
                     '_CX.dat')") trim(version),int(vAngle(Ang)),SulChS
      open(unit=106,file=filename)
      do i=1,nLines
