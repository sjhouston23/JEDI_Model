...
parameter(nJebins=9,nSteps=3) !Number of JEDI energy bins
...
write(filename,'("./JunoData/Spectra/Sul/",A,".d2s")') trim(version)
open(unit=100,file=trim(filename),status='old')
open(101,file='./Output/SulfurFlux.dat')
write(*,*)
...
!They are the extrapolated points to the highest energy detectable
